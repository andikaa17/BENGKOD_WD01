                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="nama_dokter"
                            ...
                            class="input input-bordered w-full rounded-lg text-sm @error('nama_dokter') input-error @enderror"
                            required>
                    ...
                    <div class="form-control">
                        ...
                        <select name="poli_id"
                            class="select select-bordered w-full rounded-lg text-sm @error('poli_id') select-error @enderror"
                            required>
                            <option value="">Pilih Poli</option>
                            @foreach ($polis as $item)
                                <option value="{{ $item->id }}" {{ old('poli_id', $dokter->poli_id) == $item->id ? 'selected' : '' }}>
                                    {{ $item->nama_poli }}
                                </option>
                            @endforeach
                        </select>
